      ...
      <div class="col-md-6">
        <div class="card card-info">
            <div class="card-header">
              <h4 class="card-title pull-left">Create New Employee</h4>
            ...
            <form action="{{ route('employee.store') }}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="emp_first_name" class="form-control" id="emp_first_name" placeholder="First Name">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="emp_last_name" class="col-sm-2 col-form-label">Last Name</label>
                    <div class="col-sm-10">
                      <input type="text" name="emp_last_name" class="form-control" id="emp_last_name" placeholder="Last Name">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="email" name="emp_email" class="form-control" id="emp_email" placeholder="Email">
                  </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="emp_phone" class="form-control" id="emp_phone" placeholder="Phone">
                    </div>
                </div>
